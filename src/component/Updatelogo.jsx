...
const Updatelogo = ({onNext, onContinue}) => {
  return (
      ...
      <div className="min-h-130 w-full max-w-md p-8 rounded-2xl ">
        {/* Header */}
        ...
        <form className="space-y-4">
          ...
          <button
            ...
            className="w-1/2 mx-auto block bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition mt-70"
          >
            Continue
          </button>
        {/* </form> */}
